...
import type { JobApplicationService } from "@/core/application/services/job-application.service";
import type { JobService } from "@/core/application/services/job.service";
import type { ResumeService } from "@/core/application/services/resume.service";
...
import { JobApplicationModule } from "@/modules/job-application.module";
...
export class AppContainer {
  ...
  readonly jobApplicationService: JobApplicationService;
  ...
  private constructor() {
    ...
    this.jobApplicationService = JobApplicationModule.create(this.httpClient);
    this.resumeService = ResumeModule.create(this.httpClient);
